...
import com.bofa.commons.apt4j.management.internal.extension.FreeMarkerModelElementGenerator;

import java.io.Writer;

/**
 * A {@link com.bofa.commons.apt4j.management.internal.writable.Writable} which uses the FreeMarker template engine to generate the output.
 *
...
public abstract class FreeMarkerWritable implements Writable {
    ...
    public void write(Context context, Writer writer) throws Exception {
        new FreeMarkerModelElementGenerator().generate(this, context, writer);
    }
