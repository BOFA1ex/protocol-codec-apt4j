 ...
 */
package com.bofa.commons.apt4j.management.internal.writer;
 ...
 */
public class IndentationCorrectingWriter extends Writer {
    ...
    public IndentationCorrectingWriter(Writer out) {
        super(out);
            ...
            State doHandleCharacter(char c, StateContext context) {
                switch (c) {
                    ...
                    case '\"':
                        return IN_STRING;
                    case '\r':
                        //TODO 直接无视\r, 在linux环境会换行两次, 这里把AFTER_LINE_BREAK改为默认IN_TEXT了
                        return isWindows() ? IN_LINE_BREAK : IN_TEXT;
                    case '\n':
...
//                        return isWindows() ? IN_LINE_BREAK : AFTER_LINE_BREAK;
    ...
    private static class StateContext {
        ...
        /**
         * The number of consecutive line-breaks when within {@link com.bofa.commons.apt4j.management.internal.writer.IndentationCorrectingWriter.State#AFTER_LINE_BREAK}.
         */
